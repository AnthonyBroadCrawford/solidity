...
*/
/**
 * Optimiser component that undoes what the ExpressionBreaker did, i.e.
 ...
 */
class ExpressionUnbreaker: public ASTModifier
{
public:
	explicit ExpressionUnbreaker(Block& _ast);
